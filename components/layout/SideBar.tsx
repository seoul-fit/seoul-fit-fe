...
export default function SideBar({ 
  ...
  // 선호도 토글 핸들러 (최적화)
  const handleToggle = useCallback((type: FacilityCategory) => {
    onPreferenceToggle(type);
  }, [onPreferenceToggle]);

  // 키보드 접근성을 위한 핸들러
  const handleKeyDown = useCallback((e: React.KeyboardEvent, type: FacilityCategory) => {
    ...
    <>
      ...
      >
        <div className="h-full flex flex-col">
          ...
          <div className="flex-1 p-6 overflow-y-auto overscroll-contain" style={{ scrollbarWidth: 'thin' }}>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-4">
                      <div className={`w-14 h-14 rounded-full ${config.color} flex items-center justify-center text-white transition-transform duration-200 group-hover:scale-110`}>
                        {config.icon}
                      </div>
                      <div className="flex-1 min-w-0">
