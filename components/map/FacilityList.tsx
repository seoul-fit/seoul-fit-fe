                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <Badge 
                        variant={
                          facility.congestionLevel === 'low' ? 'default' :
                          facility.congestionLevel === 'medium' ? 'secondary' : 'destructive'
                        }
                        className="text-xs"
                      >
                        {facility.congestionLevel === 'low' ? '여유' :
                         facility.congestionLevel === 'medium' ? '보통' : '혼잡'}
                      </Badge>
                    </div>
