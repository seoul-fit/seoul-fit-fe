      ...
      <CardContent className='pt-0'>
            ...
            return (
              ...
              >
                ...
                <div className='flex items-center gap-3 flex-1 min-w-0'>
                  <div
                    className={`w-10 h-10 rounded-full ${config.color} flex items-center justify-center text-white flex-shrink-0`}
                  >
                    {config.icon}
                  </div>
        ...
        <div className='mt-4 p-3 bg-gray-50 rounded-lg'>
          <p className='text-xs text-gray-600 leading-relaxed'>
            💡 원하는 시설 유형을 선택하면 지도에서 해당 마커만 표시됩니다. 실시간으로 지도가
            업데이트되어 더 쉽게 찾을 수 있어요.
          </p>
        </div>
            ...
            <div>
              ...
              <p className='text-sm font-medium text-blue-600'>
                {Object.entries(preferences)
                  ...
                  .reduce(
                    (sum, [category]) =>
                      sum + (facilityCountByCategory[category as FacilityCategory] || 0),
                    0
                  )}
              </p>
            </div>
